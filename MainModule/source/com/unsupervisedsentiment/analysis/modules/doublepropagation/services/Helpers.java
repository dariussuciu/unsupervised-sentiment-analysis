...
public class Helpers {
	...
	public static Pair getPair(String valueOpinion, String posOpinion, ElementType typeSource,
			String valueTarget, String posTarget, ElementType typeTarget, String relation,
	...
	public static Triple getTriple(String valueSource, String posSource, ElementType typeSource,
			String valueTarget, String posTarget, ElementType typeTarget, String valueH, String posH,
			...
			for (IndexedWord vertex : vertexes) {
				...
				for (SemanticGraphEdge edge : outgoingTargetEdges) {
					targets.add(Helpers.getPair(word.getValue(), word
							.getPosTag(), word.getType(), edge.getTarget().word(), edge
							.getTarget().tag(), targetType, edge.getRelation().toString(),
				...
				for (SemanticGraphEdge edge : incomingTargetEdges) {
					...
					targets.add(Helpers.getPair(word.getValue(), word
							.getPosTag(), word.getType(), edge.getSource().word(), edge
							.getSource().tag(), targetType, edge.getRelation().toString(),
							Dependency.DIRECT_DEPENDENCY));
				}
			}
		}
	...
	public static Triple createTriple(Word source, IndexedWord target,
			IndexedWord H, String relationHSource, String relationHTarget, ElementType targetType) {

		return Helpers.getTriple(source.getValue(), source.getPosTag(), source.getType(),
				target.word(), target.tag(), targetType, H.word(), H.tag(),
