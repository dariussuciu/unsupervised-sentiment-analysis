...
public class Helpers {
	 ...
	 * @return
	 */
	public static List<SemanticGraphEdge> getTargetEdgesOnRelAndTarget(Iterable<SemanticGraphEdge> edges,
			GenericRelation targetType, GenericRelation relationType, boolean isSource) {
	 ...
	 * @return
	 */
	public static List<SemanticGraphEdge> getTargetEdgesOnRel(Iterable<SemanticGraphEdge> edges,
			GenericRelation relationType) {
		List<SemanticGraphEdge> targetEdges = new ArrayList<SemanticGraphEdge>();
	...
	public static Pair getPair(String valueOpinion, String posOpinion, ElementType typeSource, String valueTarget,
			String posTarget, ElementType typeTarget, String relation, Dependency dependency) {
	...
	public static Triple getTriple(String valueSource, String posSource, ElementType typeSource, String valueTarget,
			String posTarget, ElementType typeTarget, String valueH, String posH, String relationHOpinion,
			String relationHTarget, Dependency dependency) {
	...
	public static boolean checkEquivalentRelations(GrammaticalRelation relationSourceH,
	...
	public static Set<Tuple> extractTargets(SemanticGraph semanticGraph, Set<Word> words, GenericRelation relationType,
		...
		for (Word word : words) {
			...
			for (IndexedWord vertex : vertexes) {
				...
				List<SemanticGraphEdge> outgoingTargetEdges = Helpers.getTargetEdgesOnRelAndTarget(
						semanticGraph.outgoingEdgeIterable(vertex), targetPos, relationType, false);
				...
				List<SemanticGraphEdge> incomingTargetEdges = Helpers.getTargetEdgesOnRelAndTarget(
						semanticGraph.incomingEdgeIterable(vertex), targetPos, relationType, true);
	...
	public static Triple createTriple(Word source, IndexedWord target, IndexedWord H,
			GrammaticalRelation relationHSource, GrammaticalRelation relationHTarget, ElementType targetType) {

		String relationHSourceString = relationHSource.toString();
		String relationHTargetString = relationHTarget.toString();

		return createTriple(source, target, H, relationHSourceString, relationHTargetString, targetType);
	}

	public static Triple createTriple(Word source, IndexedWord target, IndexedWord H, String relationHSource,
			String relationHTarget, ElementType targetType) {
